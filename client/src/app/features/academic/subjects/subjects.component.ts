...
@Component({
  ...
  template: `
    <div class="card" *ngIf="showForm">
      ...
      <div class="card-body">
        <div class="form-row">
          <div class="form-group"><label>{{ 'Name (English)' | t }}</label><input [(ngModel)]="form.name" placeholder="e.g. Mathematics" /></div>
...
export class SubjectsComponent implements OnInit {
  ...
  openEdit(s: any) { this.editId = s.id; this.form = { name: s.name, nameAr: s.nameAr || '', code: s.code, departmentId: s.departmentId, requiredRoomType: s.requiredRoomType }; this.showForm = true; window.scrollTo({ top: 0, behavior: 'smooth' }); }
